...
export function AppShell() {
  return (
    <div className="flex h-[100dvh] min-h-0 flex-col overflow-hidden bg-[hsl(var(--royal-black))] text-[13px] text-foreground">
      <WorkspaceHydrator />
      <TopBar />
      <div className="flex min-h-0 flex-1 gap-px overflow-x-auto bg-[hsl(var(--royal-border-soft))] p-1 pt-0 lg:overflow-hidden">
        <LeftSidebar />
        <div className="flex min-w-[min(100vw,42rem)] flex-1 flex-col overflow-hidden rounded-tl-2xl bg-background shadow-[0_0_0_1px_hsl(var(--royal-border-soft)),0_20px_80px_hsl(0_80%_3%/0.34)] md:min-w-0">
          <EditorPanel />
          <BottomPanel />
        </div>
        <PreviewPanel />
