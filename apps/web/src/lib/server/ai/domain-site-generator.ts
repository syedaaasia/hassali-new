...
export function generatePlannedWebsiteFiles(input: {
  ...
  plannedFiles["HASSALI.md"] = brief ? [
    ...
    `- **Domain/Business:** ${brief.domainId ?? (plan.sourceOfTruthDomain === "unknown" ? "unclassified" : plan.sourceOfTruthDomain) ?? plan.industry ?? "unclassified"}`,
    `- **Brand/App/Site Name:** ${brandName}`,
    `- **Brand Name Provenance:** ${qualityBlueprint.brand.nameProvenance}`,
    "- **Preview Type:** website_static_preview",
    "",
    "mode: WEBSITE",
    ...
    `brand/app/site name: ${brandName}`,
    `brandNameProvenance: ${qualityBlueprint.brand.nameProvenance}`,
    `brandNameConfirmed: ${qualityBlueprint.brand.nameProvenance === "USER_SUPPLIED" ? "true" : "false"}`,
    `previewContentIdentity: ${qualityBlueprint.previewIdentity}`,
    `contentContractBusinessType: ${qualityBlueprint.contentContract.businessType}`,
    `contentContractAudience: ${qualityBlueprint.contentContract.primaryAudience}`,
    `contentContractOffer: ${qualityBlueprint.contentContract.coreOffer}`,
    `contentContractConversionGoal: ${qualityBlueprint.contentContract.conversionGoal}`,
    `copyValidationStatus: ${qualityBlueprint.copyValidation.status}`,
    `copyValidationFindings: ${qualityBlueprint.copyValidation.findings.length}`,
    ...
    "",
    "- **Project Type:** WEBSITE",
    `- **Domain/Business:** ${plan.sourceOfTruthDomain ?? plan.industry}`,
    `- **Brand/App/Site Name:** ${brandName}`,
    "- **Preview Type:** website_static_preview",
    "",
    `projectType: WEBSITE`,
